...
public class PersonalController {
     ...
     *
     * @return      *
     * public List<Stelle> getAllStellen() { return this.stellenRepo.findAll();
     * }
     */
    /**
     ...
     * @param id
     * @return      *
     * public Stelle getStelle(String id) { return this.stellenRepo.find(id); }
     */
    /**
     * Für den Personaler die Funktion der Stelle erstellen
     *
     * @param stelle      *
     * public void newStelle(Stelle stelle) { this.stellenRepo.create(stelle); }
     */
    /**
     * Editieren je weiligen Stelle
     *
     * @param stelle      *
     * public void editStelle(Stelle stelle) { this.stellenRepo.edit(stelle); }
     */
    /**
     ...
     * @param bewerbung
     * @return      *
     * public Bewerbung editBewerbung(Bewerbung bewerbung) { return
     * this.bewerbungRepo.edit(bewerbung); }
     */
    /**
     * Bewerbungsfunktionen für das Personal
     */
    /**
     * Liefer alle offnen Bewerbungen zurück. Hier kann der Personaler per
     * Auswahl die jeweilige Stelle anschauen
     *
     * @return List<Bewerbung>
     *
    public List<Bewerbung> getAllBewerbungen() { return
     * this.bewerbungRepo.findAll(); }
     */
    /**
     ...
     * @return Bewerbung
     *
     * public Bewerbung getBewerbung(Bewerbung bewerbung) { return
     * this.bewerbungRepo.find(bewerbung); }
     */
    /**
    ...
    /*    public int getBewerbungenOfPersonaler(Personal personaler) {
